...
@Component({
  selector: 'app-match-success-dialog',
  templateUrl: './match-success-dialog.component.html',
  styleUrls: ['./match-success-dialog.component.css']
})
export class MatchSuccessDialogComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<MatchSuccessDialogComponent>,
    public user: User,
