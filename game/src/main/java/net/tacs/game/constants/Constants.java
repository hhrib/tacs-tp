package net.tacs.game.constants;
...
public class Constants {
    ...
    public static final String PLAYER_NOT_IN_MATCH_CODE = "PLAYER_NOT_IN_MATCH";
    public static final String PLAYER_NOT_IN_MATCH_DETAIL = "The Player is not on the match";
